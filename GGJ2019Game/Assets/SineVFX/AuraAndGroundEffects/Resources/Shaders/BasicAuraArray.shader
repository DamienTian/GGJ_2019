...
Shader "SineVFX/AuraEffectsPro/BasicAuraArray"
{
	Properties
	{
	...
	SubShader
	{
		...
		uniform float4 _AffectorPositions[20];
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mytempfloat_01;
			for (int w = 0; w < _AffectorCount; w++) {
			if(w == 0){
			mytempfloat_01 = distance( ase_worldPos , _AffectorPositions[w] ) - _AffectorScales[w];
			}else{
			mytempfloat_01 = min( mytempfloat_01, distance( ase_worldPos , _AffectorPositions[w] ) - _AffectorScales[w] );	
			}
			}
			mytempfloat_01 = - mytempfloat_01;



			float temp_output_18_0 = ( mytempfloat_01 + NoiseResult116 );
...
/*ASEBEGIN
Version=13903
7;29;1906;1004;1331.631;673.3262;2.373808;True;False
...
Node;AmplifyShaderEditor.Vector4Node;16;-2650.374,87.0923;Float;False;Global;_AuraSourcePosition;_AuraSourcePosition;0;0;0,0,0,0;0;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.DynamicAppendNode;17;-2375.175,115.1723;Float;False;FLOAT3;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.WorldPosInputsNode;2;-2426.315,-30.66721;Float;False;0;4;FLOAT3;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.DistanceOpNode;1;-2131.316,30.33274;Float;False;2;0;FLOAT3;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT
Node;AmplifyShaderEditor.OneMinusNode;5;-1969.312,30.33274;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1956.745,108.4552;Float;False;Constant;_Float2;Float 2;0;0;1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;20;-1778.745,59.45513;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;33;1873.747,-14.53287;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;SineVFX/AuraEffectsPro/BasicAuraArray;False;False;False;False;True;True;True;True;True;False;True;True;False;False;True;False;False;Back;0;0;False;0;0;Custom;0.5;True;False;0;True;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;2;15;10;25;False;0.5;False;2;SrcAlpha;OneMinusSrcAlpha;0;Zero;Zero;OFF;OFF;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;4;-1;-1;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=80C1F35EC84ADB89B343E2F70ABD2591D2E4BEE7